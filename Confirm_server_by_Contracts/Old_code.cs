    ...
    internal class Old_code
    {
        ...
        private async Task<int> Kick_off_err_orders(int dop_id, DateTime mod_date)
        {
            try
            {
                ...
                using (OracleConnection conO = new OracleConnection("Password=tyghbn;User ID = radkos; Data Source = prod8"))
                {
            ...
            {
                Loger.Log("Błąd modyfikacji daty produkcji (procedura awaryjna):" + e);
                return 1;
            }
        }
        ...
        private async Task<int> Create_HTMLmail(DataTable rek, string StrTableStart, string mailto, DataRow spec_kol, string tblfoot = "")
        {
            ...
            {
                Loger.Log("Błąd w wysłaniu maila:" + StrTableStart + txtwh + " To:" + mailto + " errors" + e);
                return 1;
            }
        }
