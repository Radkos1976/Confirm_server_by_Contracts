        ...
        static void Main(string[] args)
        {
            ...
            Parallel.Invoke(
                async () =>
                {
                    ...
                    List<Simple_Demands.Simple_demands_row> only_616 = await part_616.Get_source_list("^616.*", true, "Demands for 616 ", active_token);
                    ...
                    await inventory_616.Update_dataset(
                        await inventory_616.Get_PSTGR_List("Inventory part 616 ", active_token),
                        await inventory_616.Get_Ora_list("Inventory part 616 ", active_token),
                        "Inventory part 616 ",
                        active_token);
